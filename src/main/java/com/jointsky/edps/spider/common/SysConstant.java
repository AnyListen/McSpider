...
public class SysConstant {
    ...
    public static final String SPIDER_TABLE_CREATE = "CREATE TABLE IF NOT EXISTS #TABLE# (ID VARCHAR(36) PRIMARY KEY, URL VARCHAR(500) NOT NULL, PRIORITY TINYINT DEFAULT 0, REQ_STA TINYINT DEFAULT 0, CREATE_DTM TIMESTAMP NOT NULL, DONE_DTM TIMESTAMP, REQUEST CLOB);\n" +
            ...
            "CREATE INDEX IF NOT EXISTS #TABLE#__CRT_DTM ON #TABLE# (CREATE_DTM);";

    public static final String SPIDER_TABLE_RECREATE = "DROP TABLE IF EXISTS #TABLE#;CREATE TABLE #TABLE# (ID VARCHAR(36) PRIMARY KEY, URL VARCHAR(500) NOT NULL, PRIORITY TINYINT DEFAULT 0, REQ_STA TINYINT DEFAULT 0, CREATE_DTM TIMESTAMP NOT NULL, DONE_DTM TIMESTAMP, REQUEST CLOB);\n" +
            "CREATE INDEX IF NOT EXISTS #TABLE#__PRIORITY ON #TABLE# (PRIORITY DESC);\n" +
            "CREATE INDEX IF NOT EXISTS #TABLE#__REQ_STA ON #TABLE# (REQ_STA);\n" +
            "CREATE INDEX IF NOT EXISTS #TABLE#__CRT_DTM ON #TABLE# (CREATE_DTM);";
    ...
    public static final String SPIDER_TABLE_QUERY_LEFT = "SELECT * FROM #TABLE# t where t.REQ_STA = 0 ORDER BY t.PRIORITY DESC, t.CREATE_DTM ASC;";
}
